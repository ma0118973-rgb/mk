  ...
  return (
    <Link to={`/blog/${article.slug || article.id}`} className="block group relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white hover:border-pink-500 transition-all duration-300">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent p-6 flex flex-col justify-end">
            ...
            <h3 className="text-xl font-serif font-bold text-white leading-tight mb-2 group-hover:underline decoration-pink-500 decoration-2 underline-offset-4 line-clamp-3">{article.title}</h3>
